...
import type { Dividendo } from '@/types/finance';

interface DividendRowProps {
  item: Dividendo;
}

export default function DividendRow({ item }: DividendRowProps) {
  return (
    <div
      className="
    ...
    >
      ...
      {/* Valor */}
      <span className="text-xs text-cyan-400 tabular-nums shrink-0 text-right w-16 md:w-auto md:text-left">
